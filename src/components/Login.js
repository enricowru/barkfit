    ...
    <div className="min-h-screen bg-gradient-to-br from-barkfit-gray to-barkfit-dark flex items-center justify-center p-8">
      <div className="bg-barkfit-card rounded-2xl p-12 w-full max-w-md shadow-2xl border border-gray-600">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-4xl font-bold text-white mb-2 text-shadow-lg">Welcome Back</h1>
          <p className="text-gray-300 text-lg mb-0">Sign in to your BarkFit account</p>
        </div>
        ...
        {!isSuccess ? (
          ...
          <div className="text-center py-8">
            ...
            <h2 className="text-green-400 text-3xl font-bold mb-4 text-shadow-sm">Welcome Back!</h2>
            <p className="text-gray-300 text-base leading-relaxed mb-8 max-w-sm mx-auto">
              You have successfully signed in to your BarkFit account. 
        ...
        {!isSuccess && (
          <div className="text-center">
            <p className="text-gray-300 mb-4">
              ...
              <Link to="/register" className="text-barkfit-gold font-bold ml-2 transition-colors duration-300 hover:text-yellow-300">
                Sign Up
              </Link>
            </p>
